...
<nav class="flex-1 px-2 py-4 space-y-1">
    ...
    <a href="{{ route('sectoral.submissions') }}" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg bg-blue-50 text-blue-700">
        ...
        Soumissions
        @if(isset($submissions) && $submissions->where('status', 'pending')->count() > 0)
...
<div class="px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600">Examinez et traitez les soumissions de votre secteur</p>
    </div>
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-900">Soumissions ({{ $submissions->count() ?? 0 }})</h3>
        </div>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <a href="{{ route('sectoral.submissions.show', [strtolower(str_replace('Submission', '', class_basename($submission))), $submission->id]) }}" 
    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <form id="statusForm" method="POST">
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Notes sectorielles</label>
                    <textarea name="sectoral_notes" rows="3" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Ajoutez des notes..."></textarea>
                </div>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Recommandations</label>
                    <textarea name="recommendations" rows="3" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Décrivez les recommandations..."></textarea>
                </div>
...
function updateStatus(submissionId, status) {
    ...
    form.action = `/sectoral/submissions/${submissionId}/status`;
