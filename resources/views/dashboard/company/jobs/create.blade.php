            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="education_required" value="{{ old('education_required') }}"
                               class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <select name="salary_currency"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <option value="MAD" {{ old('salary_currency', 'MAD') == 'MAD' ? 'selected' : '' }}>MAD</option>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="responsibilities" rows="4"
                              class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('responsibilities') }}</textarea>
                ...
                <div>
                    ...
                    <input type="text" name="preferred_skills_input" value="{{ old('preferred_skills_input') }}"
