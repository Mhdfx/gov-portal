...
@section('page-title', 'Tableau de Bord Sectoriel')
@section('profile-route', '#')
@section('settings-route', '#')

@section('sidebar')
<nav class="flex-1 px-2 py-4 space-y-1">
    <a href="{{ route('sectoral.dashboard') }}" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg bg-blue-50 text-blue-700">
...
<div class="px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600">Bienvenue sur votre tableau de bord sectoriel</p>
    </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-semibold text-gray-900">{{ $stats['under_review_submissions'] ?? 0 }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <a href="{{ route('sectoral.submissions') }}" class="bg-white p-4 rounded-lg shadow hover:shadow-md transition-shadow border border-gray-200">
                <div class="flex items-center">
            ...
            <a href="{{ route('sectoral.analysis') }}" class="bg-white p-4 rounded-lg shadow hover:shadow-md transition-shadow border border-gray-200">
                <div class="flex items-center">
                    <i class="ri-line-chart-line text-green-600 text-2xl mr-3"></i>
                    <div>
                        <h3 class="font-medium text-gray-900">Analyse Sectorielle</h3>
                        <p class="text-sm text-gray-500">Consulter les analyses</p>
                    </div>
                </div>
            </a>
            
            <a href="{{ route('sectoral.reports') }}" class="bg-white p-4 rounded-lg shadow hover:shadow-md transition-shadow border border-gray-200">
                <div class="flex items-center">
                    <i class="ri-bar-chart-line text-yellow-600 text-2xl mr-3"></i>
                    <div>
                        <h3 class="font-medium text-gray-900">Rapports</h3>
                        <p class="text-sm text-gray-500">Générer des rapports</p>
                    </div>
                </div>
            </a>
            
            <a href="{{ route('sectoral.notifications') }}" class="bg-white p-4 rounded-lg shadow hover:shadow-md transition-shadow border border-gray-200">
                <div class="flex items-center">
                    <i class="ri-notification-3-line text-purple-600 text-2xl mr-3"></i>
                    <div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                ...
                <a href="{{ route('sectoral.submissions') }}" class="text-sm text-blue-600 hover:text-blue-700">Voir tout →</a>
            </div>
            <div class="p-6">
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                ...
                <a href="{{ route('sectoral.notifications') }}" class="text-sm text-blue-600 hover:text-blue-700">Voir tout →</a>
            </div>
            <div class="p-6">
