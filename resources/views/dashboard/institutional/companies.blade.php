...
@section('page-title', 'Companies Oversight')
...
<nav class="flex-1 px-2 py-4 space-y-1">
    ...
    <a href="{{ route('institutional.companies') }}" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg bg-blue-50 text-blue-700">
...
<div class="px-4 sm:px-6 lg:px-8 space-y-8">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <p class="text-sm uppercase tracking-wide text-gray-500">Institutional Admin • Company Management</p>
            <h1 class="text-3xl font-bold text-gray-900">Companies Oversight</h1>
            <p class="mt-2 text-gray-600">Monitor and manage companies affiliated with your institution.</p>
        </div>
    ...
    <div class="bg-white shadow rounded-2xl p-6">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <div class="md:col-span-4 flex items-end gap-3">
                ...
                <a href="{{ route('institutional.companies') }}" class="inline-flex items-center px-4 py-2 rounded-lg border border-gray-200 text-gray-700 hover:bg-gray-50">
                    Reset
                </a>
            </div>
        </form>
    ...
    <div class="bg-white shadow rounded-2xl">
        ...
        @else
            <div class="p-12 text-center">
                ...
                <a href="{{ route('institutional.companies') }}" class="inline-flex items-center px-4 py-2 rounded-lg bg-blue-600 text-white font-medium shadow hover:bg-blue-700">
                    Reset filters
                </a>
            </div>
        @endif
