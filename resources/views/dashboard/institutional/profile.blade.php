...
<nav class="flex-1 px-2 py-4 space-y-1">
    ...
    <a href="{{ route('institutional.profile') }}" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg bg-blue-50 text-blue-700">
        <i class="ri-user-line text-xl mr-3"></i>
        Profile
    </a>
</nav>
...
<div class="px-4 sm:px-6 lg:px-8">
    <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <p class="text-sm uppercase tracking-wide text-gray-500">Institutional Admin • Account</p>
            <h1 class="text-3xl font-bold text-gray-900">My Profile</h1>
            <p class="mt-2 text-gray-600">Manage your institutional admin account information and preferences.</p>
        </div>
        @if(session('success'))
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white shadow rounded-2xl p-6 text-center">
                ...
                <div class="mt-4">
                    <span class="inline-flex items-center text-xs font-semibold px-3 py-1 rounded-full bg-blue-100 text-blue-800">
                        <i class="ri-government-line mr-1"></i>Institutional Administrator
                    </span>
                </div>
            </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white shadow rounded-2xl p-6">
                ...
                <form method="POST" action="{{ route('institutional.profile.update') }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
            ...
            <div class="bg-white shadow rounded-2xl p-6">
                ...
                <form method="POST" action="{{ route('institutional.profile.password') }}" class="space-y-6">
                    @csrf
                    <div>
            ...
            <div class="bg-white shadow rounded-2xl p-6">
                ...
                <ul class="space-y-3 text-sm text-gray-600">
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <span>Never share your institutional admin credentials with anyone.</span>
                    </li>
                    <li class="flex items-start gap-3">
