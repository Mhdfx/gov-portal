...
<div class="px-4 sm:px-6 lg:px-8">
    ...
    <form method="POST" action="{{ route('company.products.update', $product->id) }}" enctype="multipart/form-data" class="bg-white shadow rounded-lg p-6">
        @csrf
        @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="category" required
                            ...
                            <option value="technology" {{ old('category', $product->category) == 'technology' ? 'selected' : '' }}>Technology</option>
                            <option value="manufacturing" {{ old('category', $product->category) == 'manufacturing' ? 'selected' : '' }}>Manufacturing</option>
                            <option value="retail" {{ old('category', $product->category) == 'retail' ? 'selected' : '' }}>Retail</option>
                            ...
                            <option value="healthcare" {{ old('category', $product->category) == 'healthcare' ? 'selected' : '' }}>Healthcare</option>
            ...
            <div>
                ...
                <div>
                    ...
                    <input type="file" name="image" accept="image/*"
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <p class="text-xs text-gray-500 mt-1">Upload a new product image (JPEG, PNG, JPG, GIF - Max 2MB). Leave empty to keep current image.</p>
